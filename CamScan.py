...
image = cv2.imread(r"C:\Users\astro\Documents\Handwriting\Images\image0.jpg")
blurred_threshold = transformation(image)

cv2.imwrite(r"C:\Users\astro\Documents\Handwriting\Images\Final_Image.jpg", cleaned_image)